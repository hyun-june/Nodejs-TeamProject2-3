...
export const MainPage = () => {
    ...
    const totalFoodCalorie = dailyFoodData ? Object.values(dailyFoodData?.data).reduce((acc, crr)=> 
        ...
        <main>
          <section>
            ...
            <div className="circle-progress-bar" style={{ 
              background : `conic-gradient( #90ADFF ${Math.floor((totalFoodCalorie / 1500) * 100)}%, transparent 0%)`
            }}>

              <Link to="/water" className="water-progress-bar">
                <div className="water-progress-value" style={{height : `${waterAmount}%`}}/>
          ...
          <section>
            {
              dailyFoodData && <div className="straght-progress sky-thema">
                ...
                <div className="straght-progress-bar">
                  <div style={{width : `${Math.floor((totalFoodCalorie / 1500) * 100)}%`}}/>
                </div>
            ...
            <div className="straght-progress semired-thema">
              ...
              <div className="straght-progress-bar">
                <div style={{width : `${Math.floor((totalExerciseCalorie / 1500) * 100)}%`}}/>
              </div>
